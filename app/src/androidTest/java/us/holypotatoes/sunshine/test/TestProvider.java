...
import us.holypotatoes.sunshine.data.WeatherContract.LocationEntry;
import us.holypotatoes.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        ContentValues testValues = us.holypotatoes.sunshine.test.TestDb.createNorthPoleLocationValues();
        ...
        us.holypotatoes.sunshine.test.TestDb.validateCursor(cursor, testValues);
        ...
        ContentValues weatherValues = us.holypotatoes.sunshine.test.TestDb.createWeatherValues(locationRowId);
        ...
        us.holypotatoes.sunshine.test.TestDb.validateCursor(weatherCursor, weatherValues);
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocation(us.holypotatoes.sunshine.test.TestDb.TEST_LOCATION),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithStartDate(
                        us.holypotatoes.sunshine.test.TestDb.TEST_LOCATION, us.holypotatoes.sunshine.test.TestDb.TEST_DATE),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithDate(us.holypotatoes.sunshine.test.TestDb.TEST_LOCATION, us.holypotatoes.sunshine.test.TestDb.TEST_DATE),
                null,
                null,
                null,
                null
    ...
    public void testGetType() {
        // content://us.holypotatoes.sunshine/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/us.holypotatoes.sunshine/weather
        assertEquals(WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://us.holypotatoes.sunshine/weather/94074
        ...
        // content://us.holypotatoes.sunshine/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/us.holypotatoes.sunshine/weather
        assertEquals(WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://us.holypotatoes.sunshine/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/us.holypotatoes.sunshine/location
        assertEquals(LocationEntry.CONTENT_TYPE, type);

        // content://us.holypotatoes.sunshine/location/1
        type = mContext.getContentResolver().getType(LocationEntry.buildLocationUri(1L));
        // vnd.android.cursor.item/us.holypotatoes.sunshine/location
    ...
    public void testUpdateAndReadWeather() {
        ...
        us.holypotatoes.sunshine.test.TestDb.validateCursor(weatherCursor, kalamazooAltered);
    }
